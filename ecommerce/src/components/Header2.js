...
export default function Header2() {
    ...
    const handleMenuClick = (e) => {
        ...
        const hasChildren = $parent.classList.contains('menu-item-has-children') ||
            ...
            $parent.classList.contains('has-sub-menu');

        if (hasChildren && ($this.getAttribute('href') === '#' || $this.classList.contains('menu-expand'))) {
            e.preventDefault();
            const $siblings = Array.from($this.parentNode.parentNode.children).filter((el) => el !== $parent);
        ...
        if ($this.tagName === 'A' || $this.tagName === 'SPAN' || $this.classList.contains('menu-expand')) {
            $parent.classList.toggle('menu-open');
        } else if ($this.tagName === 'LI' && $this.classList.contains('menu-item-has-children')) {
            $parent.classList.toggle('menu-open');
        }
    };
                    ...
                    <div className={"offcanvas_menu_wrapper " + mobileMenuSlideberActiveClass}>
                        ...
                        <div id="menu" className="text-left ">
                            <ul className="offcanvas_main_menu">
                                ...
                                <li className="menu-item-has-children" onClick={handleMenuClick}>
