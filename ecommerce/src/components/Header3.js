                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-10 col-md-8">
                                ...
                                <div className="header-bright">
                                    ...
                                    {/* Cart Icon */}
                                    <div className="mini-cart-icon" title="Cart" onClick={(e) => setMiniCartSlideberActiveClass('active')}>
                                        <a href="#">
                                    ...
                                    {/* Header Search */}
                                    <div className="header-search" onClick={(e) => setSearchSlideberActiveClass('active')}>
            ...
            <div className={"f_header_search_canvas" + searchSlideberActiveClass}>
                <div className="f_header_search_canvas-full">
                    <div className="f_header">
                        <h2>Search</h2>
                        <div className="search_close" onClick={(e) => setSearchSlideberActiveClass('')}>
            ...
            <div className={"mini-cart-area" + miniCartSlideberActiveClass}>
                <div className="mini-cart-full">
                    ...
                    <div className="mini-cart-header">
                        <h2>Shopping cart</h2>
                        <div className="mini-cart-close" onClick={(e) => setMiniCartSlideberActiveClass('')}>
